...
//            operations.forEach(System.out::println);
    ...
    public Optional<Operation> getEntityById(Long id) {
        final String FIND_BY_ID = "SELECT * FROM mydbtest.operation WHERE id='" + id + "'";
...
//                    ConnectionPool.CONNECTION_POOL.putback(connection);
    ...
    public Operation update(Operation entity) {
        final String UPDATE_OPERATION = "UPDATE mydbtest.operation SET cashier = '" + entity.getCashierName()
    ...
    public boolean delete(Long id) {
        final String DELETE_OPERATION = "DELETE FROM mydbtest.operation WHERE id = " + id;
    ...
    public boolean create(Operation entity) {
        final String INSERT_CASHIER = "INSERT INTO mydbtest.operation (cashier, client, `buy or sell`, `first currency`, `second currency`, sum, date) values ('"
