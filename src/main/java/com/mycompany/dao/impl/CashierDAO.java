...
public class CashierDAO extends AbstractDAO<Long, Cashier> {
    ...
    public List<Cashier> getAll() {
        final String SELECT_ALL_CASHIERS = "SELECT * FROM mydbtest.user";
...
//            cashiers.forEach(System.out::println);
    ...
    public Optional<Cashier> getEntityById(Long id) {
        final String FIND_BY_ID = "SELECT * FROM mydbtest.user WHERE id='" + id + "'";
...
//                    ConnectionPool.CONNECTION_POOL.putback(connection);
    ...
    public Optional<Cashier> getEntityByLogin(String login) {
        final String FIND_BY_LOGIN = "SELECT * FROM mydbtest.user WHERE login='" + login + "'";
...
//                    ConnectionPool.CONNECTION_POOL.putback(connection);
    ...
    public Cashier update(Cashier entity) {
        final String UPDATE_CASHIER = "UPDATE mydbtest.user SET mobile_phone = '" + entity.getMobilePhone()
    ...
    public boolean delete(Long id) {
        final String DELETE_CASHIER = "DELETE FROM mydbtest.user WHERE id = " + id;
    ...
    public boolean create(Cashier entity) {
        final String INSERT_CASHIER = "INSERT INTO mydbtest.user (name, surname, mobile_phone, login, password) values ('"
